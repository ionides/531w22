---
title: "Homework 3, due Monday 2/7, 11.59pm"
...
Your homework should be submitted as a single Rmd file on the course Canvas site. The GSI should be able to compile the Rmd file that you submit to HTML. Thus, any data you need to import should be read from an internet source. If technical difficulties arise, please consult your peers, piazza, the GSI or myself. 

Your report should contain a reference section listing sources. The GSI should be able to clearly identify where the sources were used, for example using reference numbers in the text. Anything and anyone consulted while you are working on the homework counts as a source and should be credited. The homework will be graded following the grading scheme in the [syllabus](../syllabus.html).
