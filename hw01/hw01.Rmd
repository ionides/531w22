---
title: "Homework 1, due Monday 1/17, 11:59pm"
...
**<big>Question 1.3. Participation report</big>**. Please copy-paste here all contributions you have made (if any) to the class Piazza site. This will be an efficient way for the grader to keep track of participation. You can also list here any other contributions you have made to our STATS/DATASCI 531 learning community during this interval, but Piazza is expected to be the most common form of active participation. Participation is graded separately from the rest of the homework, as explained in the [participation rubric](../rubric_participation.html).
