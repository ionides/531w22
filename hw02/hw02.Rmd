...
You are reminded that the grading scheme for the homework puts an emphasis on careful explanation of sources, as explained in the [syllabus](../syllabus.html). A source is any person, website or other information resource that is consulted while carrying out your homework. All sources should be listed. Be explicit about where you do NOT use sources as well as where you DO. Your homework can discuss your sources, what you learned from them, and how your solution makes use of them and goes beyond them. A fully correct solution will not get full points without explicit discussion of sources.

Question 2.3 for this homework counts toward participation credit.
Some of you are already contributing on the [course Piazza site](https://piazza.com/umich/winter2022/statsdatasci531). You can also consider participation in online discussion as part of your homework. If there is no discussion on the Piazza site that you want to join, start a new one!
...
**<big>Question 2.3. Participation report</big>**. Please copy-paste here all contributions you have made (if any) to the class Piazza site. This will be an efficient way for the grader to keep track of participation. You can also list here any other contributions you have made to our STATS/DATASCI 531 learning community during this interval, but Piazza is expected to be the most common form of active participation. If there is no discussion on the Piazza site that you want to join, start a new one! Participation is graded separately from the rest of the homework, as explained in the [participation rubric](../rubric_participation.html).
